...
## License
Apply [Artistic License 2.0](https://choosealicense.com/licenses/artistic-2.0/) for the additions under the premise of complying with [GNU LGPLv3](https://choosealicense.com/licenses/lgpl-3.0/).

The Artistic License is based on GPL License and it requires that modified versions of the software **do not prevent** users from running the [standard version](https://github.com/comex/substitute).
